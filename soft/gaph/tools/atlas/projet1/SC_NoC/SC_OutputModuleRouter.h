...
SC_MODULE(outmodulerouter)
{
	...
	int inline inAck(int Roteador, int Porta){
		if (Roteador == 0){
			if(Porta == 0) return (ack_ir0p0==SC_LOGIC_1)? 1 : 0;
			if(Porta == 2) return (ack_ir0p2==SC_LOGIC_1)? 1 : 0;
		}
		else if (Roteador == 1){
			if(Porta == 0) return (ack_ir1p0==SC_LOGIC_1)? 1 : 0;
			if(Porta == 1) return (ack_ir1p1==SC_LOGIC_1)? 1 : 0;
			if(Porta == 2) return (ack_ir1p2==SC_LOGIC_1)? 1 : 0;
		}
		else if (Roteador == 2){
			if(Porta == 1) return (ack_ir2p1==SC_LOGIC_1)? 1 : 0;
			if(Porta == 2) return (ack_ir2p2==SC_LOGIC_1)? 1 : 0;
		}
		else if (Roteador == 3){
			if(Porta == 0) return (ack_ir3p0==SC_LOGIC_1)? 1 : 0;
			if(Porta == 2) return (ack_ir3p2==SC_LOGIC_1)? 1 : 0;
			if(Porta == 3) return (ack_ir3p3==SC_LOGIC_1)? 1 : 0;
		}
		else if (Roteador == 4){
			if(Porta == 0) return (ack_ir4p0==SC_LOGIC_1)? 1 : 0;
			if(Porta == 1) return (ack_ir4p1==SC_LOGIC_1)? 1 : 0;
			if(Porta == 2) return (ack_ir4p2==SC_LOGIC_1)? 1 : 0;
			if(Porta == 3) return (ack_ir4p3==SC_LOGIC_1)? 1 : 0;
		}
		else if (Roteador == 5){
			if(Porta == 1) return (ack_ir5p1==SC_LOGIC_1)? 1 : 0;
			if(Porta == 2) return (ack_ir5p2==SC_LOGIC_1)? 1 : 0;
			if(Porta == 3) return (ack_ir5p3==SC_LOGIC_1)? 1 : 0;
		}
		else if (Roteador == 6){
			if(Porta == 0) return (ack_ir6p0==SC_LOGIC_1)? 1 : 0;
			if(Porta == 3) return (ack_ir6p3==SC_LOGIC_1)? 1 : 0;
		}
		else if (Roteador == 7){
			if(Porta == 0) return (ack_ir7p0==SC_LOGIC_1)? 1 : 0;
			if(Porta == 1) return (ack_ir7p1==SC_LOGIC_1)? 1 : 0;
			if(Porta == 3) return (ack_ir7p3==SC_LOGIC_1)? 1 : 0;
		}
		else if (Roteador == 8){
			if(Porta == 1) return (ack_ir8p1==SC_LOGIC_1)? 1 : 0;
			if(Porta == 3) return (ack_ir8p3==SC_LOGIC_1)? 1 : 0;
		}
	}
