...
public class InterfacePrincipal extends JFrame implements ActionListener{
    ...
    private void testAtlasHome(){
    	...
    	if(home==null || home.equals("")){
		    JOptionPane.showMessageDialog(this,"ATLAS_HOME environment variable do not exist.\n" +
    ...
    private boolean testGnuplot(){
		try{
			...
			try{
				Process p = Runtime.getRuntime().exec(Default.gnuplot2);
				p.destroy();
	...
	*/
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource() == menuExit){
			...
			JOptionPane.showMessageDialog(null,"ATLAS          02.10.2012\nDeveloped by:\n       GAPH - Hardware Design Support Group","VERSION 1.0.2",JOptionPane.INFORMATION_MESSAGE);
	}
	...
	*/
	private void setButtonsEnabled(){
		...
		btnPower.setEnabled(project.isPowerEstimated());
	}
