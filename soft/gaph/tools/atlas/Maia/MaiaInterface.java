...
public class MaiaInterface extends NoCGenerationGUI implements ActionListener{
	...
	public MaiaInterface(Project project){
		super("NoC Generation   "+project.getPath());
	...
	private void addComponents(){
		...
		//routing algorithm
		y=y+63;
		String[] availableAlgorithm = {"XY","West-First Minimal","Negative-First Minimal"};
		String selectedAlgorithm = "XY";
		if(noc.getRoutingAlgorithm().equalsIgnoreCase("AlgorithmWFM"))
			selectedAlgorithm = "West-First Minimal";
		else if(noc.getRoutingAlgorithm().equalsIgnoreCase("AlgorithmNFM"))
			selectedAlgorithm = "Negative-First Minimal";
